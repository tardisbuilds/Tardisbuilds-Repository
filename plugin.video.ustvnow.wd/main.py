...
addon_logo = xbmc.translatePath(os.path.join(plugin_path,'wardoctor.png'))
...
if mode == 'main':
    ...
    if int(Addon.get_setting('notify')) == 1:
        xbmcgui.Dialog().notification(addonname + ' is provided by:','Tardis Builds',addon_logo,5000,False)
    ...
    if channels:
        for c in channels:
            rURL = "plugin://plugin.video.ustvnow.wd/?name=" + c['name'] + "&mode=play&rand=" + Addon.random_generator()
            name = c["name"];
            if name == 'AE':
                name = 'A&E'
            if name == 'MY9':
            ...
            if Addon.get_setting('rec_live') == 'true' and Addon.get_setting('dvr') == 'true' and quality_type == 3:
                ...
                cm_menu = [cm_refresh]
            if quality_type == 3 and name != 'PBS' and name != 'My9':
                quality_name = 'High';
            elif quality_type == 2 and name != 'PBS' and name != 'My9':
                quality_name = 'High';
            elif quality_type == 1 and name != 'PBS' and name != 'My9':
                quality_name = 'Medium';
            else:
                quality_name = 'Low';
    ...
    if recordings:
        for r in sorted(recordings, key=lambda k: k['datetimestart'], reverse=True):
            rURL = "plugin://plugin.video.ustvnow.wd/?scheduleid=" + str(r['scheduleid']) + "&mode=play_dvr&rand=" + Addon.random_generator()
            channel = r['channel']
            if r['channel'] == 'AE':
                channel = 'A&E'
            if r['channel'] == 'MY9':
            ...
            if Addon.get_setting('rec_live') == 'true' and dvrtimertype == 0 and Addon.get_setting('dvr') == 'true' and mediatype != 'MV' and rec_quality_type == 2:
                ...
                cm_menu = [cm_refresh]
            if rec_quality_type == 3 and channel != 'PBS' and channel != 'My9':
                quality_name = 'High';
            elif rec_quality_type == 2 and channel != 'PBS' and channel != 'My9':
                quality_name = 'High';
            elif rec_quality_type == 1 and channel != 'PBS' and channel != 'My9':
                quality_name = 'Medium';
            else:
                quality_name = 'Low';
    ...
    if now:
        for r in now:
            ...
            if r['channel'] == 'ESPN2HD':
                channel = 'ESPN 2'
            rURL = "plugin://plugin.video.ustvnow.wd/?name=" + channel + "&mode=play&rand=" + Addon.random_generator()
            if r['channel'] == 'AE':
                channel = 'A&E'
            if r['channel'] == 'MY9':
                channel = 'My9'
            ...
            if Addon.get_setting('rec_live') == 'true' and Addon.get_setting('dvr') == 'true' and quality_type == 3:
                ...
                cm_menu = [cm_refresh]
            if quality_type == 3 and channel != 'PBS' and channel != 'My9':
                quality_name = 'High';
            elif quality_type == 2 and channel != 'PBS' and channel != 'My9':
                quality_name = 'High';
            elif quality_type == 1 and channel != 'PBS' and channel != 'My9':
                quality_name = 'Medium';
            else:
                quality_name = 'Low';
