...
ORDER          = ['sportsaccess', 'communityportal', 'tvportal', 'sportsmania', 'sportsnationhdtv', 'ultimatemania', 'dexter', 'reboot', 'ivue', 'tardistv', 'vpnicity', 'overlordtv', 'stargatestreams']

LOGINID = { 
	'tardistv': {
		'name'     : 'Tardis TV',
		'plugin'   : 'script.tardisepg',
		'saved'    : 'logintardistv',
		'path'     : os.path.join(ADDONS, 'script.tardisepg'),
		'icon'     : os.path.join(ADDONS, 'script.tardisepg', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'script.tardisepg', 'fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'tardistv_login'),
		'settings' : os.path.join(ADDONS, 'script.tardisepg', 'settings.xml'),
		'default'  : 'username',
	...
	'stargatestreams': {
		...
		'file'     : os.path.join(LOGINFOLD, 'stargatestreams_login'),
		'settings' : os.path.join(ADDONS, 'plugin.video.stargate-streams', 'settings.xml'),
		'default'  : 'Username',
		'data'     : ['Username', 'Password'],
		'activate' : ''}
}
