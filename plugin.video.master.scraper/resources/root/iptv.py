...
def iptv4sat():
	...
	dest = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.master.scraper/downloads/', 'iptv4sat.zip'))
	...
	for a in dir:
		if a.endswith('.m3u'):
			...
			os.remove(xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.master.scraper/downloads/',a)))
