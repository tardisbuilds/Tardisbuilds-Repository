...
PATH    = os.path.join(tardis.PROFILE, l1lll1 (u"ࠩ࡬ࡴࡹࡼ࡟ࡤࡪࡤࡲࡳ࡫࡬ࡴࠩࢴ"))
SETTING = l1lll1 (u"ࠪࡐࡔࡍࡉࡏࡡࡌࡔ࡙࡜ࠧࢵ")

def getURL(url):
    if tardis.validTime(SETTING, 60 * 60 * 24): 
...
def l1l1lllll(l1ll1111l):
    ...
    tardis.SetSetting(l1ll1111l, str(now))
...
def l1l1llll1(e):
    ...
    tardis.log(e)
    tardis.DialogOK(l111111l, l11111l1, l11111ll)    
    tardis.SetSetting(SETTING, l1lll1 (u"ࠫࠬ࣋"))
