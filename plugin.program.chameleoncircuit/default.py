...
ADDON=xbmcaddon.Addon(id='plugin.program.chameleoncircuit')
    
    
VERSION = "1.0.2"
PATH = "chameleoncircuit"            

    
def CATEGORIES():
    link = OPEN_URL('http://tardisbuilds.com/tardiswizard/introwizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Chameleon Circuit","Downloading ",'', 'Please Wait')
    ...
    time.sleep(2)
    dp.update(0,"", "Extracting Data Please Wait")
    print '======================================='
    print addonfolder
    print '======================================='
